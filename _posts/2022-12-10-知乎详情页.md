...
这个是把回答、文章、想法等详情页接入线上长容器的交互
<video id="video" controls="" preload="none" autoplay="autoplay" width=320 height=480>
    <source id="mp4" src="/img/2022-12-10/omni_video.mp4" type="video/mp4">
</video>
